...
st.set_page_config(
    page_title="Shohei Ohtani Batting Stats Dashboard v1.0",
...
with stats_col1:
    ...
    with col1:
        ...
        # )
        season_batter_stats_all = query.create_df(
            "SELECT * FROM master_batting_stats_all_1522;"
        )
...
ohtani_stats_batter_1822 = query.create_df("SELECT * FROM ohtani_stats_batter_1822;")
...
with mid_col_r2:
    ...
    ba_at_strike_count_sho = query.create_df("SELECT * FROM ba_at_strike_count_sho;")
...
with mid_col2_r2:
    ...
    # )
    ba_at_strike_count_all_1522 = query.create_df(
        "SELECT * FROM ba_at_strike_count_all_1522;"
    )
...
with mid_col_r4:
    ...
    stats_at_risp_sho_1822 = query.create_df("SELECT * FROM stats_at_risp_sho_1822;")
...
with mid_col2_r4:
    ...
    stats_at_risp_all_1522 = query.create_df("SELECT * FROM stats_at_risp_all_1522;")
...
with left_column_r3:
    ...
    #     "./data/batting/master_batting_stats_all_1522.csv"
    # )
    master_batting_stats_all_1522 = query.create_df(
        "SELECT * FROM master_batting_stats_all_1522;"
    )
